...
dependencies {
    ...
    val promptOverlayApi = "net.dungeon-hub.prompt-overlay:api:${project.property("minecraft_version")}-0.3.0"
...
tasks.shadowJar {
    ...
    relocate("com.squareup.moshi", "net.dungeonhub.guildplus.libs.moshi")
    relocate("com.squareup.okio", "net.dungeonhub.guildplus.libs.okio")
    relocate("okio", "net.dungeonhub.guildplus.libs.okio")
    relocate("okhttp3", "net.dungeonhub.guildplus.libs.okhttp3")
    relocate("io.ktor", "net.dungeonhub.guildplus.libs.ktor")
    relocate("com.hypercubetools", "net.dungeonhub.guildplus.libs.hypercubetools")
    relocate("com.google.gson", "net.dungeonhub.guildplus.libs.gson")
    relocate("com.fasterxml.jackson", "net.dungeonhub.guildplus.libs.jackson")
    relocate("jakarta", "net.dungeonhub.guildplus.libs.jakarta")
    relocate("org.apache.commons", "net.dungeonhub.guildplus.libs.apache.commons")
    relocate("org.yaml.snakeyaml", "net.dungeonhub.guildplus.libs.snakeyaml")
    relocate("io.github.oshai.kotlinlogging", "net.dungeonhub.guildplus.libs.kotlinlogging")
    relocate("com.teamresourceful.resourcefulconfigkt", "net.dungeonhub.guildplus.libs.resourcefulconfigkt")
